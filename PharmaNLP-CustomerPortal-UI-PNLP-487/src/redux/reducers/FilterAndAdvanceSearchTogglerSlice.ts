...
const FilterAndAdvanceSearchTogglerSlice = createSlice({
    ...
    reducers: {
        ...
        setContentRefHeight : (state, action: PayloadAction<{filteringContentRefHeight : number,advanceSearchContentRefHeight : number}>) => {
            return {
                ...state,
        ...
        setActiveContent : (state,action : PayloadAction<{activeContent : string}>) => {
            return {
                ...state,
                activeContent : action["payload"]["activeContent"]
            }
...
export const { setCurrentTogglerToFilterOrAdvanceSearch,setContentRefHeight,setActiveContent } = FilterAndAdvanceSearchTogglerSlice.actions;
